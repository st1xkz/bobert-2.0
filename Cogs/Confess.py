...
class Confess(commands.Cog):
    ...
    async def on_message(self, message):
        ...
        if message.channel.id == 806649868314869760:
            ...
            embed = discord.Embed(title="Success", description=f"I've received your confession and sent it to the <#806649874379964487> channel!", color=0x2f3136)
            ...
            embed = discord.Embed(description=f"**Message deleted in <#806649868314869760>** \n{message.content}", color=0xFF4040)
        ...
        if ctx.channel.type == discord.ChannelType.private:
            ...
            try:
                ...
                if msg:
                    ...
                    embed = discord.Embed(description=f"**Message deleted in DMs** \n{msg.content}", color=0xFF4040)
